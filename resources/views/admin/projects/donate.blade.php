   ...
   <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">募金された金額合計: {{ $project->total_donated_format }} 円</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped projects">
                                ...
                                <tbody>
                                    @foreach($project->donates as $donate)
                                    <tr @if($donate->state != 1) class="donate-canceled" @endif>
                                        ...
                                        <td>{{ $donate->money }}  円</td>
                                         <td class="project-actions text-right">
                                            @if($donate->state == 1)
                                            {!! Form::open(['method' => 'PUT', 'route'=>['admin.projects.donate.cancel', $donate], 'style'=> 'display:inline', 'title' => 'Delete']) !!} 
                                                {!! Form::button('<i class="fas fa-user-minus"></i> キャンセル', ['class' => 'btn btn-warning btn-sm donate-cancel', 'name' => 'submit', 'type' => 'submit']) !!} 
                                            {!! Form::close() !!}
                                            @else
                                            {!! Form::open(['method' => 'PUT', 'route'=>['admin.projects.donate.confirm', $donate], 'style'=> 'display:inline', 'title' => 'Delete']) !!} 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			{!! Form::open(['method' => 'POST', 'route'=>['admin.projects.donate.store', $project]]) !!} 
